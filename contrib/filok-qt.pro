...
RESOURCES += src/qt/filok.qrc src/qt/filok_locale.qrc

TRANSLATIONS += src/qt/locale/filok_bg.ts \
                src/qt/locale/filok_de.ts \
                src/qt/locale/filok_en.ts \
                src/qt/locale/filok_es.ts \
                src/qt/locale/filok_fi.ts \
                src/qt/locale/filok_fr.ts \
                src/qt/locale/filok_it.ts \
                src/qt/locale/filok_ja.ts \
                src/qt/locale/filok_pl.ts \
                src/qt/locale/filok_pt.ts \
                src/qt/locale/filok_ru.ts \
                src/qt/locale/filok_sk.ts \
                src/qt/locale/filok_sv.ts \
                src/qt/locale/filok_vi.ts \
                src/qt/locale/filok_zh_CN.ts \
                src/qt/locale/filok_zh_TW.ts
