/* src/config/filok-config.h.  Generated from filok-config.h.in by configure.  */
/* src/config/filok-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://filok.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Filok Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Filok Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "filok"
