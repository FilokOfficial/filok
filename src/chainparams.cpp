...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000a0e4dbd92a982eaf679bff1265e2202a72b180076722d3a695bb7389dc5"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1548269016, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Filok Experiment Goes Live";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1548269016;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 23529546;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000a0e4dbd92a982eaf679bff1265e2202a72b180076722d3a695bb7389dc5"));
        assert(genesis.hashMerkleRoot == uint256("0xf026e920994fcaa2cf69b5ef76c5705f62ae4ed5e684dc0342808a65ff313fb2"));
        

        vSeeds.push_back(CDNSSeedData("seed1.filok.io", "seed1.filok.io"));
        vSeeds.push_back(CDNSSeedData("seed2.filok.io", "seed2.filok.io"));
        vSeeds.push_back(CDNSSeedData("seed3.filok.io", "seed3.filok.io"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1548269016; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1548269017;
        genesis.nNonce = 21587617;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ba4bafe0c1a56238c433a8f0df675cc9a51a1e67e873d82ecfb63cd249b"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Filok BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Filok BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Filok BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1548269017;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1548269018;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 6;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x4ca4d040542ae0778f1a0dd154ceeaf30c3b97a50675c35db2330200d45d49ad"));
