                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Filok-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Filok address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and filok: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Filok Core"), this);
    aboutAction->setStatusTip(tr("Show information about Filok Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Filok"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Filok addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Filok addresses"));
    ...
    openAction->setStatusTip(tr("Open a Filok: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Filok Core help message to get a list with possible Filok command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Filok Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Filok network", "", count));
}
...
{
    QString strTitle = tr("Filok Core"); // default title
