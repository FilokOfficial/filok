...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FLK features */
        {"filok", "masternode", &masternode, true, true, false},
        {"filok", "masternodelist", &masternodelist, true, true, false},
        {"filok", "mnbudget", &mnbudget, true, true, false},
        {"filok", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"filok", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"filok", "mnsync", &mnsync, true, true, false},
        {"filok", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"filok", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use filokd, or the -server option to filok-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Filok Alert\" admin@foo.com\n"),
...
{
    return "> filok-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18291/\n";
}
